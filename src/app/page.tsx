  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        // Also store in cookies (for middleware/server-side use)
      ...
      >
        ...
        <div className="w-full lg:w-[55%] 2xl:w-[60%] bg-[url('/images/dotsBGImage.png')] bg-cover py-[30px] px-[20px] md:py-[35px] md:px-[80px] 2xl:px-[128px] flex justify-center items-center">
          <form
            ...
            className="bg-white rounded-[20px] outline-1 outline-offset-[-1px] outline-[#cdc8c8]/20 px-[20px] py-[30px] lg:py-[35px] 2xl:px-[45px]"
          >
            <div
