    ...
    <div className="container">
     ...
     <div className="flex gap-6 flex-col lg:flex-row mt-[33px]">
      ...
      <div className=" w-full lg:w-[65%] max-w-[955px] mx-auto  ">
       <Image src="/images/mainnews.png" alt="earth" width={955} height={425} className="w-full     object-cover rounded-xl md:rounded-[30px]" priority />
...
/>
       ...
       <div className="mt-[46px]">
        <Image src="/images/keys.png" alt="laptop" width={955} height={425} className="w-full   object-cover rounded-xl md:rounded-[30px]" priority />
       </div>
       ...
       <div className="mt-[46px] lg:mb-[119px] mb-[20px] flex flex-wrap lg:flex-nowrap items-center justify-center md:justify-start md:items-start text-center gap-x-2 gap-y-2 text-md sm:text-lg md:text-xl  2xl:text-2xl  font-medium ">
        ...
        <Image src="/link.svg" alt="Sarah Image" height={17} width={18} className="ml-[20px] cursor-pointer self-center" />
       </div>
      </div>
