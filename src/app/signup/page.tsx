...
const HomePage = () => {
  ...
  const handleSubmit = () => {
    if (active === "tools") {
      ...
      console.log("Personal Account Submission:");
      console.log("First Name:", firstName);
      console.log("Last Name:", lastName);
      console.log("Email:", email);
      console.log("Country:", country);
      ...
      console.log("Business Account Submission:");
      ...
      <div className={`${jost.className} flex flex-col lg:flex-row min-h-screen`}>
        ...
        <div className="w-full lg:w-[55%] 2xl:w-[60%] bg-[url('/images/dotsBGImage.png')] bg-cover py-[30px] px-[20px] md:py-[35px] md:px-[80px] 2xl:px-[128px] flex justify-center items-center">
          <div className="bg-white rounded-[20px] md:rounded-[39px] outline-1 outline-offset-[-1px] outline-[#cdc8c8]/20 px-[20px] py-[30px] lg:py-[35px] 2xl:px-[45px]">
            ...
            <div className="h-auto bg-stone-50 flex sm:flex-row rounded-3xl mb-[24px] rounded-xl outline-[1.31px] outline-offset-[-1.31px] outline-Colorstroke">
              <div
                onClick={() => setActive("tools")}
                className={`w-full sm:w-1/2 rounded-xl flex justify-center items-center gap-2 cursor-pointer py-2 lg:py-4 text-[20px] ${
                  active === "tools" ? "bg-[#E5223A]" : "bg-stone-50"
            ...
            {active === "tools" ? (
              <>
                ...
                <div className="flex flex-col md:flex-row gap-[22px] mt-6">
                  <div className="w-full md:w-1/2">
                    <div
                      className="text-[#1C1B35] text-md 2xl:text-2xl xl:text-xl md:text-lg font-medium"
                      style={{ fontFamily: "Jost, sans-serif" }}
                    >
                      First Name
                    </div>
