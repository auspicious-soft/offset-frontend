...
//  const [showPasswordd, setShowPasswordd] = useState(false); // add this state
...
//       <div className="mt-[30px] mb-[15px] text-[#1C1B35] text-md 2xl:text-2xl xl:text-xl md:text-lg font-medium">Account Type</div>
...
//           <input type="text" name="firstName" placeholder="Enter First Name" className="text-[#7E7F91] text-sm 2xl:text-xl xl:text-lg md:text-md font-normal w-full focus:outline-none bg-transparent" />
//          </div>
//         </div>
//        </div>
...
//         <div className="relative">
//          <div className="flex items-center border border-[#7C7C7C40] rounded-2xl w-full mt-3 px-5 py-3 gap-3">
//           <input type="text" name="lastName" placeholder="Enter Last Name" className="text-[#7E7F91] text-sm 2xl:text-xl xl:text-lg md:text-md font-normal w-full focus:outline-none bg-transparent" />
//          </div>
//         </div>
//        </div>
//       </div>
...
//       />
//       <Image
//         src={showPassword ? "/images/redEye.png" : "/images/redEye.png"}
...
//       />
//       <Image
//         src={showPasswordd ? "/images/redEye.png" : "/images/redEye.png"}
//         alt="Toggle visibility"
//         width={18}
//         height={10}
//         className="h-[8px] w-[12px] md:h-[10px] md:w-[18px] cursor-pointer"
...
//     type="checkbox"
//     id="terms"
//     className="w-[27px] h-[27px] accent-[#E5223A] mt-1 rounded-lg border-[1.52px] border-Colorstroke"
//   />
   ...
   <div className="flex flex-col lg:flex-row min-h-screen">
    ...
    <div className="w-full lg:w-[40%] h-auto lg:h-auto relative object-contain">
     <Image
      ...
      width={829}
      height={1217}
      className="w-full max-h-[1000px] h-full object-cover"
     />
    ...
    <div className="w-full lg:w-[60%] bg-[url('/images/dotsBGImage.png')] bg-cover py-16 px-8 md:py-15 md:px-16 2xl:py-[189px] 2xl:px-[128px]">
     <div className="px-4 py-6 md:px-8 md:py-10 bg-white rounded-[39.18px] outline-1 outline-offset-[-1px] outline-stone-300/20">
      ...
      <div className="mt-4 text-[#7E7F91] text-sm 2xl:text-xl xl:text-lg md:text-md font-normal">
       Create your Offset7 account to access real-time threat intelligence, secure your data, and stay ahead of cyber threats.
      </div>
       ...
       <>
        ...
        <div className="relative">
         <div
          ...
          className="cursor-pointer border flex items-center border-[#7C7C7C40] rounded-2xl w-full mt-3 px-5 py-3 gap-3"
         >
          <select
           ref={selectRef}
           name="country"
           ...
           className="text-[#7E7F91] bg-transparent text-sm 2xl:text-xl xl:text-lg md:text-md font-normal w-full focus:outline-none appearance-none cursor-pointer"
          >
           <option value="" disabled>
            Select Country
           </option>
          ...
          <Image
           ...
           width={18}
           height={10}
           className="h-[8px] w-[12px] md:h-[10px] md:w-[18px]"
          />
         </div>
        </div>
