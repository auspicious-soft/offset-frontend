  ...
  <>
   ...
   <div className="mb-10 md:mb-15">
    <div className="container px-4 sm:px-6 lg:px-8 bg-[url('/images/dotsBGImage.png')] bg-no-repeat bg-cover min-h-screen">
     ...
     <div className="mt-8 grid grid-cols-1 lg:grid-cols-3  gap-[50px]">
      <div className="lg:col-span-2">
       ...
       <div className="md:mb-[51px] mb-[25px]  ">
        ...
        <div className=" flex-wrap gap-4 grid grid-cols-1 md:grid-cols-2  ">
         ...
         <div
          className={`border rounded-2xl  outline-[1.50px] outline-offset-[-1.50px] bg-white outline-stone-300/30  md:pt-[35px] md:pb-[29px] md:px-[28px] p-4 flex flex-col w-full cursor-pointer relative ${selectedFrequency === "monthly" ? "border-[#E5223A]" : "border-gray-200"}`}
         ...
         >
          ...
          {selectedFrequency === "monthly" &&  <Image height={20} width={20} src="/images/redTick.png" alt="check" className="absolute top-15 right-3" />}
         </div>

         <div
          className={`border rounded-2xl  outline-[1.50px] bg-white outline-offset-[-1.50px] md:pt-[35px] md:pb-[29px] md:px-[28px] p-4  w-full flex flex-col cursor-pointer relative ${selectedFrequency === "yearly" ? "border-[#E5223A]" : "border-gray-200"}`}
         ...
         >
          ...
          {selectedFrequency === "yearly" && <Image height={20} width={20} src="/images/redTick.png" alt="check" className="absolute top-15 right-3" />}
         </div>
       ...
       <div className="mb-[51px] ">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 xl:grid-cols-3 gap-4">
         {/* Credit / Debit Card */}
         <div key="credit" className={`border rounded-2xl bg-white px-4 h-16 relative cursor-pointer ${selectedPayment === "credit" ? "border-[#E5223A]" : "border-gray-200"}`} onClick={() => setSelectedPayment("credit" as any)}>
         ...
         <div
          key="paypal"
          className={`border rounded-2xl outline-[1.5px] bg-white outline-offset-[-1.5px] outline-stone-300/30 p-4 py-[29px]  flex items-center justify-center cursor-pointer h-16 relative ${selectedPayment === "paypal" ? "border-[#E5223A]" : "border-gray-200"}`}
          onClick={() => setSelectedPayment("paypal" as any)}
         >
          <div className="flex items-center ">
           <Image src="/images/Layer_5.svg" alt="Google Pay" width={122} height={32} />
          </div>
         ...
         <div
          key="apple"
          className={`border rounded-2xl  outline-[1.50px] bg-white outline-offset-[-1.50px] outline-stone-300/30 p-4 py-[29px]   flex items-center justify-center cursor-pointer h-16 relative ${selectedPayment === "apple" ? "border-[#E5223A]" : "border-gray-200"}`}
          onClick={() => setSelectedPayment("apple" as any)}
         >
          <div className="flex items-center gap-2">
           <Image src="/images/Layer_1.svg" alt="Google Pay" width={93} height={54} />
          </div>
         ...
         <div
          key="google"
          className={`border rounded-2xl  outline-[1.50px] bg-white outline-offset-[-1.50px] outline-stone-300/30 p-4 py-[29px]  flex items-center justify-center cursor-pointer h-16 relative ${selectedPayment === "google" ? "border-[#E5223A]" : "border-gray-200"}`}
          onClick={() => setSelectedPayment("google" as any)}
         >
          <div className="flex items-center gap-2">
           <Image src="/images/Layer_2.svg" alt="Google Pay" width={69} height={69} />
          </div>
        ...
        <div className="space-y-4">
         <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:mt-[53px] mt-[20px]">
          <div>
           ...
           <Input id="cardNumber" placeholder="4242 4242 4242 4242" className=" mt-1 lg:px-[20px] lg:py-[24px] pl-[20px] py-[24px] rounded-xl outline-1 outline-offset-[-0.97px] bg-white outline-neutral-400" />
           {/* <Image
           src="/images/Layer_4.svg"
            alt="Credit Card"
            width={41}
            height={41}
            className="absolute top-1  z right-3 -translate-y-1/2"
           /> */}
          </div>
          <div className="grid grid-cols-2 gap-4">
           <div className="w-full">
            ...
            <div className="relative w-full">
             <Input id="expiryDate" placeholder="DD/MM/YYYY" className="mt-1  bg-white lg:px-[44px] xl:px-[44px] 2xl:px-[44px] pl-[36px] py-[24px] rounded-xl  outline-1 outline-offset-[-0.97px] outline-neutral-400" />
           ...
           <div>
            ...
            <Input id="cvv" placeholder="123" className="mt-1 lg:px-[20px] bg-white lg:py-[24px] pl-[20px] py-[24px] rounded-xl outline-1 outline-offset-[-0.97px] outline-neutral-400" />
           </div>
          </div>
         </div>
         <div>
          ...
          <div className="relative w-full">
           <Input id="cardName" placeholder="John Smith" className="mt-1 bg-white lg:px-[54px]  lg:py-[24px] pl-[50px] py-[24px] rounded-xl outline-1 outline-offset-[-0.97px] outline-neutral-400" />
           <div className="absolute top-1/2 left-[15px] -translate-y-1/2">
            <Image src="/Profile.svg" alt="Profile" width={19} height={24} className="h-[20px] w-[15px] ml-2 md:h-[24px] md:w-[19px]" />
           </div>
          </div>
         </div>
        </div>
