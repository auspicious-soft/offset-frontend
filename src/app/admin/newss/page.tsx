...
<div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mt-[20px]">
  <div className="justify-start text-[#1C1B35] text-5xl font-medium">
    Dark Web Market Shutdown: Authorities Seize Illegal Data<br />
    Trading Hub
  </div>
...
<div className="text-[#1C1B35] text-base sm:text-lg md:text-xl lg:text-2xl font-normal mt-[46px]">
  It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).
</div>

<div className="text-[#1C1B35] text-base sm:text-lg md:text-xl lg:text-2xl font-normal mt-[24px]">
...
<div className="mt-[46px] justify-start text-[#1C1B35] text-5xl sm:text-4xl md:text-5xl font-medium">
  Authorities Seize Illegal Data Trading Hub
</div>

<div className="text-[#1C1B35] text-base sm:text-lg md:text-xl lg:text-2xl font-normal mt-[46px]">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alter ation in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition,humour and the like).</div>
